...
class UploadManager extends Component {
    ...
    onProgress(fieldId, progress) {
        const { onUploadProgress } = this.props,
        request = this.requests[filedId];
            ...
            .end((err, res) => {
                ...
                if (typeof onUploadEnd === 'function') {
                    onUploadEnd(file.id, {
                        ...
                        status: error && uploadStauts.FAILED || uploadStatus.UPLOADED
                    });
                }
            });
    }
